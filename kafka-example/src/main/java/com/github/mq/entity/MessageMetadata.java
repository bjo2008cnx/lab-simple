...
public class MessageMetadata {
    ...
    @JsonCreator
    public MessageMetadata(@JsonProperty("timestamp") long timestamp, @JsonProperty("id") String id, @JsonProperty("externalMetadata") Map<String, String>
            externalMetadata) {
        this.id = id;
